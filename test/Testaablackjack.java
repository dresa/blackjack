/*
 * @(#)Testaablackjack.java 29.4.2003
 *
...
/**
 * Testaablackjack on l‰hes identtinen luokan Blackjack kanssa. Testaablackjack
 * mahdollistaa kuitenkin komentoriviparametrit testausta varten ja antaa mahdollisuuden
 * tuoda oma, j‰rjestetty pakka peliin helpommin k‰ytt‰en konstruktoria
 * Testaablackjack(Korttipakka).
 *
 * @author  Esa Junttila
 * @version 29.4.2003
 */
public class Testaablackjack extends Frame 
                       implements ActionListener, MouseListener {

    /**
     * Testaablackjack-pelin k‰ynnistysmetodi
     */
    public static void main(String[] args) {
         Korttipakka haluttuPakka = new Korttipakka(Saannot.PAKALLISIA_PELISSA); //Pelkk‰ alkuarvo...
         

         //MUODOSTETAAN PAKAN PAALLIMAISET KORTIT PARAMETRIN MUKAAN:
         if (args != null) {
              if (args.length >= 1) {

                   //Kaikki kortit pata‰ssi‰:
                   if ( args[0].equals("1") )
                        haluttuPakka = new Testaakorttipakka("assa");

                   //Normaali pelaajan voitto 19 - 17
                   if ( args[0].equals("2") ) {
                        Kortti[] kortit = { Kortti.luoKortti("risti", 10),
                                            Kortti.luoKortti("pata", 7),
                                            Kortti.luoKortti("ruutu", 9),
                                            Kortti.luoKortti("risti", 9),
                                            Kortti.luoKortti("hertta", 1) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Normaali pelaajan tappio 20 - 21
                   if ( args[0].equals("3") ) {
                        Kortti[] kortit = { Kortti.luoKortti("risti", 1),
                                            Kortti.luoKortti("pata", 13),
                                            Kortti.luoKortti("risti", 9),
                                            Kortti.luoKortti("ruutu", 5),
                                            Kortti.luoKortti("ruutu", 6) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Tasapeli jakajan hyv‰ksi 19 - 19
                   if ( args[0].equals("4") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 9),
                                            Kortti.luoKortti("ruutu", 3),
                                            Kortti.luoKortti("risti", 12),
                                            Kortti.luoKortti("ruutu", 5),
                                            Kortti.luoKortti("hertta", 1) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaaja menee yli 24 - 7
                   if ( args[0].equals("5") ) {
                        Kortti[] kortit = { Kortti.luoKortti("risti", 10),
                                            Kortti.luoKortti("hertta", 7),
                                            Kortti.luoKortti("hertta", 4),
                                            Kortti.luoKortti("ruutu", 10) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Jakaja menee yli 14 - 22
                   if ( args[0].equals("6") ) {
                        Kortti[] kortit = { Kortti.luoKortti("risti", 6),
                                            Kortti.luoKortti("risti", 10),
                                            Kortti.luoKortti("pata", 8),
                                            Kortti.luoKortti("hertta", 2),
                                            Kortti.luoKortti("pata", 12) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaajan Blackjack 21 - 3
                   if ( args[0].equals("7") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 1),
                                            Kortti.luoKortti("risti", 3),
                                            Kortti.luoKortti("risti", 10) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaajan Blackjack 21 - 12 (jakaja ottaa yhden kortin)
                   if ( args[0].equals("8") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 1),
                                            Kortti.luoKortti("ruutu", 13),
                                            Kortti.luoKortti("hertta", 10),
                                            Kortti.luoKortti("ruutu", 2)  };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Molempien Blackjack
                   if ( args[0].equals("9") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 12),
                                            Kortti.luoKortti("hertta", 1),
                                            Kortti.luoKortti("ruutu", 1),
                                            Kortti.luoKortti("pata", 13)  };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Jakajan normaali Blackjack-voitto 19 - 21 (vakuutusta ei voi tehd‰)
                   if ( args[0].equals("10") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 11),
                                            Kortti.luoKortti("hertta", 10),
                                            Kortti.luoKortti("ruutu", 9),
                                            Kortti.luoKortti("ruutu", 1) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Jakaja saa Blackjackin 18 - 21 ja pelaaja ON VAKUUTTANUT
                   if ( args[0].equals("11") ) {
                        Kortti[] kortit = { Kortti.luoKortti("ruutu", 3),
                                            Kortti.luoKortti("risti", 1),
                                            Kortti.luoKortti("hertta", 4),
                                            Kortti.luoKortti("hertta", 1),
                                            Kortti.luoKortti("hertta", 12) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Jakaja saa Blackjackin 24 - 21 ja pelaaja ON VAKUUTTANUT
                   if ( args[0].equals("12") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 12),
                                            Kortti.luoKortti("risti", 1),
                                            Kortti.luoKortti("pata", 4),
                                            Kortti.luoKortti("pata", 10),
                                            Kortti.luoKortti("ruutu", 13) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Jakaja ei saa Blackjackia. 20 - 19 (pelaaja ON VAKUUTTANUT)
                   if ( args[0].equals("13") ) {
                        Kortti[] kortit = { Kortti.luoKortti("hertta", 12),
                                            Kortti.luoKortti("hertta", 1),
                                            Kortti.luoKortti("risti", 3),
                                            Kortti.luoKortti("ruutu", 7),
                                            Kortti.luoKortti("risti", 8) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Jakaja ei saa Blackjackia. 18 - 19  (pelaaja ON VAKUUTTANUT)
                   if ( args[0].equals("14") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 8),
                                            Kortti.luoKortti("hertta", 1),
                                            Kortti.luoKortti("pata", 11),
                                            Kortti.luoKortti("ruutu", 8) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaaja tuplaa pelins‰ ja h‰vi‰‰ normaalisti 19 - 20
                   if ( args[0].equals("15") ) {
                        Kortti[] kortit = { Kortti.luoKortti("risti", 8),
                                            Kortti.luoKortti("hertta", 9),
                                            Kortti.luoKortti("pata", 2),
                                            Kortti.luoKortti("pata", 9),
                                            Kortti.luoKortti("ruutu", 2),
                                            Kortti.luoKortti("ruutu", 9) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaaja tuplaa pelins‰ ja voittaa 21 - 17
                   if ( args[0].equals("16") ) {
                        Kortti[] kortit = { Kortti.luoKortti("pata", 5),
                                            Kortti.luoKortti("hertta", 12),
                                            Kortti.luoKortti("pata", 6),
                                            Kortti.luoKortti("pata", 13),
                                            Kortti.luoKortti("ruutu", 7) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaaja jakaa kaksi ysi‰ ja peli p‰‰ttyy 19/17 - 18
                   if ( args[0].equals("17") ) {
                        Kortti[] kortit = { Kortti.luoKortti("ruutu", 9),
                                            Kortti.luoKortti("ruutu", 10),
                                            Kortti.luoKortti("pata", 9),
                                            Kortti.luoKortti("hertta", 12),
                                            Kortti.luoKortti("hertta", 8),
                                            Kortti.luoKortti("pata", 8) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaaja jakaa kaksi ysi‰ ja peli p‰‰ttyy 19/17 - 20
                   if ( args[0].equals("18") ) {
                        Kortti[] kortit = { Kortti.luoKortti("ruutu", 9),
                                            Kortti.luoKortti("ruutu", 10),
                                            Kortti.luoKortti("pata", 9),
                   ...
                   //Pelaaja jakaa kaksi ysi‰ ja peli p‰‰ttyy 19/20 - 17
                   if ( args[0].equals("19") ) {
                        Kortti[] kortit = { Kortti.luoKortti("ruutu", 9),
                                            Kortti.luoKortti("ruutu", 10),
                                            Kortti.luoKortti("pata", 9),
                   ...
                   //Pelaaja jakaa kaksi ‰ss‰‰ ja peli p‰‰ttyy 19/21 - 17
                   if ( args[0].equals("20") ) {
                        Kortti[] kortit = { Kortti.luoKortti("ruutu", 1),
                                            Kortti.luoKortti("ruutu", 10),
                                            Kortti.luoKortti("pata", 1),
                                            Kortti.luoKortti("hertta", 8),
                                            Kortti.luoKortti("ruutu", 13),
                                            Kortti.luoKortti("pata", 7) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Kaikki erikoistoiminnot saatavilla
                   if ( args[0].equals("21") ) {
                        Kortti[] kortit = { Kortti.luoKortti("risti", 5),
                                            Kortti.luoKortti("ruutu", 1),
                                            Kortti.luoKortti("pata", 5) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
                   //Pelaaja menee yli 23 - 3
                   if ( args[0].equals("22") ) {
                        Kortti[] kortit = { Kortti.luoKortti("hertta", 8),
                                            Kortti.luoKortti("hertta", 3),
                                            Kortti.luoKortti("hertta", 5),
                                            Kortti.luoKortti("pata", 11) };
                        haluttuPakka = new Testaakorttipakka(kortit);
                   }
         ...
         Testaablackjack ikkuna = new Testaablackjack(haluttuPakka);
         ikkuna.setSize(640,480);
         ikkuna.setTitle("Testaablackjack by Esa");
  ...
  //-------VƒRIT:
    /** Testaablackjackin peli-ikkunan taustav‰ri*/
  ...
  //-------MUUTTUJAT:
    /** Mit‰ ja mink‰ kokoista pakkaa t‰m‰ Testaablackjack-peli k‰ytt‰‰*/
    private Korttipakka pakka = new Korttipakka(Saannot.PAKALLISIA_PELISSA);
    
    /** Testaablackjack-pelin alussa annettavan raham‰‰r‰n suuruus*/
...
//----------------------------------------------
  ...
  //-------
    ...
    /**
     * Testausta varten luotu konstruktori.
     */
    public Testaablackjack(Korttipakka pakka) {
         this();
         this.pakka = pakka;    
    }
...
//-------
    ...
    /**
     * Metodi suorittaa halutun Testaablackjackin toiminnon ja
     * ohjaa peli‰ oikeaan suuntaan. T‰ss‰ tapahtuu koko
     * Testaablackjack-pelin ylin kontrolli. Metodi hoitaa myˆs
...
// HIIRITAPAHTUMAT:
    ...
    /**
     * Muodostetaan ohjelman ohjeet ja Testaablackjackin s‰‰nnˆt sis‰lt‰v‰ ikkuna.
...
/**
 * Itse Testaablackjack-ohjelman sulkemista helpottava luokka
 */
...
/**
 * Testaablackjackin ohjeikkunan piilottamista helpottava luokka. Kun
